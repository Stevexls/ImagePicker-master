...
import com.stevexls.imagepicker.ui.ImageGridActivity;
...
//    }
     ...
     * @return
     */
    public SelectionCreator showSelected(boolean showSelected) {
        mSelectionSpec.showSelected = showSelected;
        return this;
    }

    /**
     * @param multiMode true:单选, false: 多选
     * @return
     */
    public SelectionCreator multiMode(boolean multiMode) {
        mSelectionSpec.multiMode = multiMode;
        return this;
    }
     ...
     * @return
     */
    public SelectionCreator selectedItems(@NonNull List<Item> list) {
        if(mSelectionSpec.selectedItems == null) {
            mSelectionSpec.selectedItems = new ArrayList<>();
        }
        mSelectionSpec.selectedItems.addAll(list);
        return this;
    }

    public SelectionCreator statucBarDarkMode(boolean statusBarDarkMode) {
        mSelectionSpec.statusBarDarkMode = statusBarDarkMode;
        return this;
    }
